...
If you want to run [Terraform with the IBM Cloud provider](https://github.com/ocp-power-automation/terraform-provider-ibm) plugin on your system, complete the following steps:
